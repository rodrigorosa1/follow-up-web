...
import { postProcedures, updateProcedures } from "../../services/skill.service";
...
interface ModalProcedureyProps {
...
export const ModalProcedure: React.FC<ModalProcedureyProps> = ({ procedure, isOpen, onClose, id, onSnackbarOpen, getSkill }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            if (procedure?.id) {
                updateProcedures(procedure.id, values);
            } else {
